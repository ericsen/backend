...
use App\Models\Api\BetLogRaw_JC;
...
class JC
{
    ...
    public function __construct(Request $request)
    {
        // 基本資料
        $this->_brand = 'JC';
        $this->_apiUrl = 'http://slot.cckgaming.com/game/slot/';
        ...
        // 網址Mapping
        $this->_methodUrl = [
            'createUser' => 'http://slot.cckgaming.com/createuser',
            'getLoginUrl' => 'http://slot.cckgaming.com/',
            'kickPlayer' => 'http://slot.cckgaming.com/kickuser',
            'deposit' => 'http://slot.cckgaming.com//deposit',
            'withdraw' => 'http://slot.cckgaming.com/withdraw',
            'getBalance' => 'http://slot.cckgaming.com/getbalance',
            'syncBet' => 'http://slot.cckgaming.com/betlist',
    ...
    {
        DB::table('g_gamelist')
            ->where('GameCode', "JC-$mid")
            ->update(['GameTech' => $cid, 'Status' => $status]);

        return [
            'db' => DB::table('g_gamelist')->where('GameCode', "JC-$mid")->first(),
            'data' => [
                'mid' => $mid,
