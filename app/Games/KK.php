...
use App\Models\Api\BetLogRaw_KK;
...
class KK
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->_brand = 'KK';
        $this->_version = '1.0';
        $this->_apiUrl = 'https://webapi.kk-cai.com/';
        $this->_platformId = '1326078048309149697';
        $this->_tenantId = '1243366715667578881';
        $this->_tenantKey = '0d28d84a-dcb8-4abb-ab0f-7e162cbbdfda';

        $this->request = $request;

        // 網址Mapping
        $this->_methodUrl = [
            'createUser' => 'https://userapi.kk-cai.com/createuser',
            'getLoginUrl' => 'https://userapi.kk-cai.com/login',
            'kickPlayer' => 'https://userapi.kk-cai.com/kickuser',
            'deposit' => 'https://webapi.kk-cai.com/fund/deposit',
            'withdraw' => 'https://webapi.kk-cai.com/fund/withdraw',
            'getBalance' => 'https://webapi.kk-cai.com/fund/getbalance',
            'syncBet' => 'https://webapi.kk-cai.com/data/betlist',
            'syncOfficialBet' => 'https://webapi.kk-cai.com/data/official/betlist',
            'syncPrebuy' => 'https://webapi.kk-cai.com/data/prebuylist',
            'syncOfficialPrebuy' => 'https://webapi.kk-cai.com/data/official/prebuylist',
        ];
        // 語系Mapping
        $this->_lang = [
            'zh_tw' => 'TWN',
     ...
     * @return string
     */
    public function getLoginUrl($userId, $gameCode = null, $odds = 1956, $backUrl = '')
    {
